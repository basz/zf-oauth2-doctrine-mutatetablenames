...
namespace ZF\OAuth2\DoctrineMutateTableNames;

use Doctrine\Common\EventManager;
use Zend\EventManager\EventInterface;
use Zend\ModuleManager\Feature;
use ZF\OAuth2\DoctrineMutateTableNames\EventListener\MutateTableNamesSubscriber;
    ...
    Feature\DependencyIndicatorInterface
{
    ...
    public function onBootstrap(EventInterface $e)
    {
        ...
        $subscriber = $serviceLocator->get('ZF\OAuth2\DoctrineMutateTableNames\MutateTableNamesSubscriber');
